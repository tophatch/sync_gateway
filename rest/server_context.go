...
func (sc *ServerContext) startShadowing(dbcontext *db.DatabaseContext, shadow *ShadowConfig) error {
	...
	base.Warn("Bucket Shadowing feature comes with a number of limitations and caveats. See https://github.com/tophatch/sync_gateway/issues/1363 for more details.")
